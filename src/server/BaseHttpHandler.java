...
public class BaseHttpHandler {
    protected void sendCorrectRequest(HttpExchange h, String text) throws IOException {
    ...
    protected void sendSuccessfullyCreated(HttpExchange h, String text) throws IOException {
        byte[] response = text.getBytes(StandardCharsets.UTF_8);
        h.getResponseHeaders().add("Content-Type", "application/json;charset=utf-8");
